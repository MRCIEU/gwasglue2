...
We will start by performing a meta-analysis for the `chd` trait, using the `ieu-a-7` and `ukb-d-I9_IHD` MRC IEU OpenGWAS study IDs.
...
chd_dat <- createDataSet(traits=c("ieu-a-7", "ukb-d-I9_IHD"), variants = hmgcr_chrpos, tools = c("finemap","coloc"), source = "IEUopenGWAS", harmonise = TRUE, tolerance = 0.08, action = 1) %>% 
