---
title: "Tutorial 4: Alternative regional genotype-phenotype map example, with meta-analyses included"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tutorial 4: Alternative regional genotype-phenotype map example}
