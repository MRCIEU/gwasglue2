...
Create the summary sets, followed by the dataset which includes them.
...
Finally, we perform the meta-analysis to create a new summary set
 
 ```{r}
 meta_chd <- dataset%>%
    create_meta_summaryset(.)
 ```
